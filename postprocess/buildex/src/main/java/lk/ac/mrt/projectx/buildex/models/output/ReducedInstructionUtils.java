...
/**
 * Created by krv on 1/19/17.
 */
public class ReducedInstructionUtils {
            ...
            case OP_movss:
                ...
                if (cinst.isBounds( 1, 1 )) {
                    ...
                    if (dst.getType() == MemoryType.MEM_STACK_TYPE || dst.getType() == MemoryType.MEM_HEAP_TYPE) {
                        ReducedInstruction inst0 = new ReducedInstruction( X86Analysis.Operation.op_assign, dst_low, true );
                        inst0.getSrcs().add( src_low );
                        // get upper bits
                        ...
                        ReducedInstruction inst1 = new ReducedInstruction( X86Analysis.Operation.op_assign, dst_hight, true );
                        inst1.getSrcs().add( immediate );
...
//                    amount = 2;
                    ...
                    ReducedInstruction inst0 = new ReducedInstruction( X86Analysis.Operation.op_mul, output_low, true );
                    inst0.getSrcs().add( input32_1 );
                    inst0.getSrcs().add( input32_2 );
                    ReducedInstruction inst1 = new ReducedInstruction( X86Analysis.Operation.op_mul, output_high, true );
            ...
            case OP_push:
                // [esp -4] [dst[1]] <- src[0]
                if (cinst.isBounds( 2, 2 )) {
//                    amount = 1;
                    ReducedInstruction inst0 = new ReducedInstruction( X86Analysis.Operation.op_assign, cinst.getDsts().get( 1 ),
                            false );
            ...
            case OP_pop:
                ...
                if (cinst.isBounds( 2, 2 )) {
//                    amount = 1;
                    ReducedInstruction inst0 = new ReducedInstruction( X86Analysis.Operation.op_assign, cinst.getDsts().get( 0 ),
                            false );
...
//                    amount = 1;
            ...
            case OP_vmulss:
            case OP_vmulsd:
                if (cinst.isBounds( 1, 2 )) {
                    ReducedInstruction inst0 = new ReducedInstruction( X86Analysis.Operation.op_mul, cinst.getDsts().get( 0 ),
                            false );
                    inst0.getSrcs().add( cinst.getSrcs().get( 0 ) );
                    inst0.getSrcs().add( cinst.getSrcs().get( 1 ) );
                    rInstructions.add( inst0 );
            ...
            case OP_vaddsd:
                if (cinst.isBounds( 1, 2 )) {
                    ReducedInstruction inst0 = new ReducedInstruction( X86Analysis.Operation.op_add, cinst.getDsts().get( 0 ),
                            false );
                    inst0.getSrcs().add( cinst.getSrcs().get( 0 ) );
                    inst0.getSrcs().add( cinst.getSrcs().get( 1 ) );
                    rInstructions.add( inst0 );
            ...
            case OP_imul:
                ...
                if (cinst.isBounds( 1, 2 )) {
                    ...
                    // virtual <= eax * src0
                    ReducedInstruction inst0 = new ReducedInstruction( X86Analysis.Operation.op_mul, virtualReg, true );
                    inst0.getSrcs().add( cinst.getSrcs().get( 1 ) );
                    inst0.getSrcs().add( cinst.getSrcs().get( 0 ) );

                    // edx <= split_h(virtual)
                    ReducedInstruction inst1 = new ReducedInstruction( X86Analysis.Operation.op_split_h, cinst.getDsts().get( 0 ), true );
                    inst1.getSrcs().add( virtualReg );

                    // eax <= split_l(virtual)
                    ReducedInstruction inst2 = new ReducedInstruction( X86Analysis.Operation.op_split_l, cinst.getDsts().get( 1 ), true );
            ...
            case OP_mul:
                if (cinst.isBounds( 2, 2 )) {
                    ...
                    // virtual <= eax * src0
                    ReducedInstruction inst0 = new ReducedInstruction( X86Analysis.Operation.op_mul, virtualReg, false );
                    inst0.getSrcs().add( cinst.getSrcs().get( 1 ) );
                    inst0.getSrcs().add( cinst.getSrcs().get( 0 ) );

                    // edx <= split_h(virtual)
                    ReducedInstruction inst1 = new ReducedInstruction( X86Analysis.Operation.op_split_h, cinst.getDsts().get( 0 ), false );
                    inst1.getSrcs().add( virtualReg );

                    // eax <= split_l(virtual)
                    ReducedInstruction inst2 = new ReducedInstruction( X86Analysis.Operation.op_split_l, cinst.getDsts().get( 1 ), false );
                    inst2.getSrcs().add( virtualReg );
            ...
            case OP_idiv:
                ...
                if (cinst.isBounds( 2, 3 )) {
                    ...
                    // edx <= split_h(virtual)
                    ReducedInstruction inst1 = new ReducedInstruction( X86Analysis.Operation.op_split_h, cinst.getDsts().get( 0 ),
                            true );
                    inst1.getSrcs().add( virtualReg );

                    // eax <= split_l(virtual)
                    ReducedInstruction inst2 = new ReducedInstruction( X86Analysis.Operation.op_split_l, cinst.getDsts().get( 1 ),
                            true );
                    inst2.getSrcs().add( virtualReg );
            ...
            case OP_cdq:
                ...
                // edx <- eax
                if (cinst.isBounds( 1, 1 )) {
                    ReducedInstruction inst0 = new ReducedInstruction( X86Analysis.Operation.op_signex,
            ...
            case OP_cwde:
                // eax <- ax
                if (cinst.isBounds( 1, 1 )) {
                    ReducedInstruction inst0 = new ReducedInstruction( X86Analysis.Operation.op_signex, cinst.getDsts().get( 0 ),
                            true );
                    inst0.getSrcs().add( cinst.getSrcs().get( 0 ) );
                    rInstructions.add( inst0 );
                } else {
            ...
            case OP_xchg:
                ...
                if (cinst.isBounds( 2, 2 )) {
                    ...
                    // virtual <- src[0]
                    ReducedInstruction inst0 = new ReducedInstruction( X86Analysis.Operation.op_assign, virtualReg, false );
                    inst0.getSrcs().add( cinst.getSrcs().get( 0 ) );
                    // dst[0] <- src[1]
                    ReducedInstruction inst1 = new ReducedInstruction( X86Analysis.Operation.op_assign, cinst.getDsts().get( 0 ),
                            false );
                    inst1.getSrcs().add( cinst.getSrcs().get( 1 ) );
                    // dst[1] <- virtual
                    ReducedInstruction inst2 = new ReducedInstruction( X86Analysis.Operation.op_assign, cinst.getDsts().get( 1 ),
                            false );
                    inst1.getSrcs().add( virtualReg );
                    rInstructions.add( inst0 );
                    rInstructions.add( inst1 );
            ...
            case OP_psubd:
                if (cinst.isBounds( 1, 2 )) {
                    ...
                    if (first.getType() == second.getType() && first.getValue() == second.getValue()) {
                        ...
                        inst0 = new ReducedInstruction( X86Analysis.Operation.op_assign, cinst.getDsts().get( 0 ), false );
                        inst0.getSrcs().add( zero );
                    } else {
                        X86Analysis.Operation op = null;
                        switch (cinst.getOpcode()) {
                            case OP_xorps:
                            case OP_xor:
                            case OP_pxor:
                                op = X86Analysis.Operation.op_xor;
                                break;
                            case OP_sub:
                            case OP_psubd:
                                op = X86Analysis.Operation.op_sub;
                                break;
                        }
            ...
            case OP_or:
                ...
                if (cinst.isBounds( 1, 2 )) {
                    ...
                    switch (cinst.getOpcode()) {
                        case OP_add:
                            op = X86Analysis.Operation.op_add;
                            break;
                        case OP_and:
                        case OP_andpd:
                            op = X86Analysis.Operation.op_and;
                            break;
                        case OP_or:
                            op = X86Analysis.Operation.op_or;
                            break;
                    }
            ...
            case OP_neg:
                if (cinst.isBounds( 1, 1 )) {
                    ReducedInstruction inst0 = new ReducedInstruction( X86Analysis.Operation.op_sub, cinst.getDsts().get( 0 ),
                            false );
                    inst0.getSrcs().add( cinst.getSrcs().get( 0 ) );
                    rInstructions.add( inst0 );
                } else {
            ...
            case OP_sar:
                if (cinst.isBounds( 1, 2 )) {
                    ReducedInstruction inst0 = new ReducedInstruction( X86Analysis.Operation.op_rsh, cinst.getDsts().get( 0 ),
                            true );
                    inst0.getSrcs().add( cinst.getSrcs().get( 1 ) );
                    inst0.getSrcs().add( cinst.getSrcs().get( 0 ) );
                    rInstructions.add( inst0 );
            ...
            case OP_psllq:
                if (cinst.isBounds( 1, 1 )) {
                    ReducedInstruction inst0 = new ReducedInstruction( X86Analysis.Operation.op_lsh, cinst.getDsts().get( 0 ),
                            false );
                    inst0.getSrcs().add( cinst.getSrcs().get( 1 ) );
                    inst0.getSrcs().add( cinst.getSrcs().get( 0 ) );
                    rInstructions.add( inst0 );
            ...
            case OP_not:
                if (cinst.isBounds( 1, 1 )) {
                    ReducedInstruction inst0 = new ReducedInstruction( X86Analysis.Operation.op_not, cinst.getDsts().get( 0 ),
                            false );
                    inst0.getSrcs().add( cinst.getSrcs().get( 0 ) );
                    rInstructions.add( inst0 );
                } else {
            ...
            case OP_lea:
                ...
                if (cinst.isBounds( 1, 4 )) {
                    if ((((Integer) cinst.getSrcs().get( 0 ).getValue()) == 0) &&
                    ...
                    if (((Integer) cinst.getSrcs().get( 2 ).getValue()) == 0) {
                        ...
                        ReducedInstruction inst1 = new ReducedInstruction( X86Analysis.Operation.op_add, virtualReg, true );
                        inst1.getSrcs().add( virtualReg );
                        inst1.getSrcs().add( cinst.getSrcs().get( 0 ) );

                        // dst <- virtual + disp
                        ReducedInstruction inst2 = new ReducedInstruction( X86Analysis.Operation.op_add, cinst.getDsts().get( 0 ),
                                true );
                        inst2.getSrcs().add( virtualReg );
                ...
                if (cinst.isBounds( 1, 2 )) {
                    ...
                    if (cinst.getSrcs().get( 0 ).getType() == cinst.getSrcs().get( 1 ).getType()
                        ...
                        Operand immediate0 = new Operand( MemoryType.IMM_INT_TYPE, cinst.getSrcs().get( 1 ).getWidth(),
                                0 );
                        inst0 = new ReducedInstruction( X86Analysis.Operation.op_assign, cinst.getDsts().get( 0 )
                                , true );
                        inst0.getSrcs().add( immediate0 );
                    } else {
                        inst0 = new ReducedInstruction( X86Analysis.Operation.op_sub, cinst.getDsts().get( 0 )
                                , true );
                        inst0.getSrcs().add( cinst.getSrcs().get( 1 ) );
                        inst0.getSrcs().add( cinst.getSrcs().get( 0 ) );
                    }
                    ...
                    if (cf) {
                        ...
                        Operand immediate1 = new Operand( MemoryType.IMM_INT_TYPE, cinst.getSrcs().get( 1 ).getWidth(),
                                1 );
                        ReducedInstruction inst1 = new ReducedInstruction( X86Analysis.Operation.op_sub, cinst.getDsts().get( 0 )
                                , true );
            ...
            case OP_adc:
                if (cinst.isBounds( 1, 2 )) {
                    ...
                    if (cf) {
                        Operand immediate1 = new Operand( MemoryType.IMM_INT_TYPE, cinst.getSrcs().get( 1 ).getWidth(),
                                1 );
                        ReducedInstruction inst1 = new ReducedInstruction( X86Analysis.Operation.op_add, cinst.getDsts().get( 0 ),
                                true );
                        inst1.getSrcs().add( cinst.getDsts().get( 0 ) );
                        inst1.getSrcs().add( immediate1 );
                        rInstructions.add( inst1 );
            ...
            case OP_xadd:
                if (cinst.isBounds( 2, 2 )) {
                    Operand virtualReg = new Operand( MemoryType.REG_TYPE, cinst.getSrcs().get( 0 ).getWidth(),
                            DR_REG_VIRTUAL_1.ordinal() );
                    virtualReg.regToMemRange();
                    ReducedInstruction inst0 = new ReducedInstruction( X86Analysis.Operation.op_add, virtualReg, true );
                    inst0.getSrcs().add( cinst.getSrcs().get( 0 ) );
                    inst0.getSrcs().add( cinst.getSrcs().get( 1 ) );

                    ReducedInstruction inst1 = new ReducedInstruction( X86Analysis.Operation.op_assign, cinst.getSrcs().get( 1 ),
                            true );
                    inst1.getSrcs().add( cinst.getSrcs().get( 0 ) );

                    ReducedInstruction inst2 = new ReducedInstruction( X86Analysis.Operation.op_assign, cinst.getSrcs().get( 0 ),
                            true );
                    inst2.getSrcs().add( virtualReg );
            ...
            case OP_fdiv:   // Divide ST(0) by m32fp and store result in ST(0).
                ...
                if (cinst.isBounds( 1, 2 )) {
                    ...
                    switch (cinst.getOpcode()) {
                        ...
                        case OP_fdivp:
                        case OP_fdiv:
                            op = X86Analysis.Operation.op_div;
                            break;
                    }
