 ...
 * TODO:This class should not be created from us but this should be generated by defines.h in DynamoRIO
...
/* 1082 */     OP_vgatherqpd, /**
         * < vgatherqpd opcode
         */
/* 1083 */     OP_vbroadcasti128, /**
         * < vbroadcasti128 opcode
         */
/* 1084 */     OP_vinserti128, /**
         * < vinserti128 opcode
         */
/* 1085 */     OP_vextracti128, /**
         * < vextracti128 opcode
         */
/* 1086 */     OP_vpmaskmovd, /**
         * < vpmaskmovd opcode
...
/* 1098 */     OP_vpsrlvq, /**
    ...
    /* Keep these at the end so that ifdefs don't change internal enum values */
        ...
        OP_AFTER_LAST;
        public final int OP_FIRST;
        public final int OP_LAST;
        ...
        public Operation DrLogicalToOperation() {
            ...
            switch (this) {
                case OP_jnl:
                case OP_jnl_short:
                    retOp = Operation.op_ge;
                    break;
                case OP_jl:
                case OP_jl_short:
                    retOp = Operation.op_lt;
                    break;
                case OP_jnle:
                case OP_jnle_short:
                    retOp = Operation.op_gt;
                    break;
                case OP_jnz:
                case OP_jnz_short:
                    retOp = Operation.op_neq;
                    break;
                case OP_jz:
                case OP_jz_short:
                    //ZF value
                    retOp = Operation.op_eq;
                    break;
                case OP_jb:
                case OP_jb_short:
                    retOp = Operation.op_lt;
